...
@Component({
  ...
  styles: [`
    ...
    .btn-ghost {
      @apply bg-transparent text-secondary-700 hover:bg-secondary-50 focus:ring-secondary-500;
    }
    
    .btn-outline {
      @apply bg-transparent border border-primary-500 text-primary-500 hover:bg-primary-50 focus:ring-primary-500;
    }
